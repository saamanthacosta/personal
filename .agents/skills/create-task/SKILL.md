...
- [ ] 2/11  explore             (OpenSpec + CVE threat model + polish hooks)
...
- [ ] 6/11  pre-commit-review   (blocker taxonomy; loads ponytail-review when needed)
...
| `ponytail-review` | loads | by name (slash) |
| `ponytail-audit` | loads | by name (slash) |
| `ponytail-debt` | loads | by name (slash) |
